...
export default function SettingsScreen({ navigation, route }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.obsidian }]}>
      ...
      {/* header */}
      <View style={[styles.headerArea, { backgroundColor: theme.colors.midnight, flexDirection: 'row', alignItems: 'center' }]}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={{ padding: 10 }}>
            <Ionicons name="arrow-back" size={24} color={theme.colors.ivory} />
        </TouchableOpacity>
        <Text style={[theme.typography.displayS, { color: theme.colors.gold, textAlign: 'center', flex: 1, marginRight: 44 }]}>Settings</Text>
      </View>
          ...
          {expandedSection === 'about' && (
            <GlassCard style={[styles.expandedBox, { borderTopLeftRadius: 0, borderTopRightRadius: 0 }]} glowOnPress={false}>
              ...
              <View style={[styles.aboutRow, { borderBottomWidth: 0 }]}>
                ...
                <Text style={[theme.typography.body, { color: theme.colors.ivory }]}>TouristSync Team</Text>
              </View>
            </GlassCard>
          )}
